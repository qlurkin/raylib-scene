...
DEPS = Cube.h Object.h ModelObject.h compute.h GPU.h ParticleSystem.h Effect.h Gravity.h
OBJ = main.o Object.o Cube.o ModelObject.o compute.o GPU.o ParticleSystem.o Gravity.o
